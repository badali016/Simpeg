...
@section('content')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-0">
        ...
        <div class="mb-4 md:mb-6">
            <h2 class="text-2xl md:text-3xl font-bold text-slate-900">Tambah Jabatan</h2>
            <p class="text-xs md:text-sm text-slate-600 mt-1">Isi formulir berikut untuk menambahkan jabatan baru</p>
        </div>
